...
> Writing test cases. Not too familiar with Mocha/Chai.
...
> Using websockets. Short polling would probably pose performance issues.

**4. How did you find the test overall? If you have any suggestions on how we can improve the test, we'd love to hear them!**

> Great. Only concern is that since the assignment is pretty open-ended, it can be tough to decide how extensive the implementation should be (eg. folder structure, error handling, etc.).
